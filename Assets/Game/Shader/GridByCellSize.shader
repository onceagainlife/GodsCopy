Shader "UI/GridByCellSize"
{
    Properties
    {
        ...
        _CellSizeX  ("Cell Size X", Range(0.01, 1)) = 0.1
        _CellSizeY  ("Cell Size Y", Range(0.01, 1)) = 0.1
        _LineWidth  ("Line Width", Range(0.0005, 0.05)) = 0.003
    }
